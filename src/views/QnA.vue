      ...
      <div class="container qna">
        <div class="columns">
          <div class="column is-offset-3 is-7 is-text">
            ...
            <h3>기타</h3>
            <h4>장병규 의장님은 왜 몰입캠프를 운영하나요?</h4>
            <p>장병규 운영자는, 본인이 KAIST 학부생일 때, 유관 동아리와 주변 환경의 영향으로 인하여, 프로그래밍 아르바이트 및 집중적인 프로그래밍 활동 등으로 크게 성장한 경험을 가지고 있습니다. 후학들에게 해당 경험을 전하고 싶은 마음으로 몰입캠프를 운영 중입니다.</p>
