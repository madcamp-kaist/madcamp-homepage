...
'title': '[공지] 2021년도 몰입캠프 겨울학기 모집(코로나19 상황에 따라 추후 변동 가능) ',
'content':
...
'title': '[공지] 2021년도 몰입캠프 여름학기 모집(코로나19 상황에 따라 추후 변동 가능) ',
'content':
...
'title': '[공지] 2020년도 몰입캠프 겨울학기 모집(코로나19 상황에 따라 추후 변동 가능) ',
'content':
...
export function notices_page(page) {
    return notices.slice().reverse().slice((page-1)*10, page*10);
}
